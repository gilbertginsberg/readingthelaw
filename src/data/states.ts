...
export const states: StateProgram[] = [
  {
    ...
    considerations: [
      ...
      "California's overall bar exam pass rate for non-ABA-law-school-educated candidates is meaningfully lower than for ABA law school graduates, so go in with clear eyes about the odds.",
  ...
  },
  {
    ...
    considerations: [
      ...
      "Because there's no interim exam, your only true checkpoint before the bar exam is your supervisor's periodic certification, so pick a rigorous supervisor, not just an available one.",
  ...
  },
  {
    ...
    considerations: [
      ...
      "Because both reader and sponsor must be approved by the Board before starting, you cannot begin informally the way you can in some other states, so plan for an approval process up front.",
  ...
  },
  {
    ...
    considerations: [
      ...
      "This path is uncommon enough that few current attorneys or law schools have direct experience advising candidates through it, so expect to do extra homework.",
    ],
    steps: [
